...
export function Evolution() {
  return (
    <AnimatedSection id="evolution" className="section-padding relative overflow-hidden">
      <div
                ...
                >
                  ...
                  <div className={`relative overflow-hidden bg-gradient-to-b ${stage.color} p-6`}>
                    <motion.img
                      src={stageImages[i]}
                      alt={stage.name}
                      className="mx-auto h-48 w-full object-contain drop-shadow-lg transition-transform duration-500 group-hover:scale-110 sm:h-56"
                    />
                  ...
                  <div className="p-5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="rounded-full bg-cyan-glow/10 px-2 py-0.5 font-mono text-xs text-cyan-glow">
                        {stage.population}
                      </span>
                    </div>
